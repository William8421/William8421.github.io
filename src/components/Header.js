  ...
  return (
    <div className='header'>
      <a className='imgContainer' href='#/' >
        ...
        <a className='page-desktop' href='#/' >Home</a>
        <a className='page-desktop' href='#about' >About</a>
        <a className='page-desktop' href='#projects' >Projects</a>
        <a className='page-desktop' href='#contact' >Contact</a>
        </div>
